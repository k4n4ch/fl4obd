...
> SOC は PID `015B`（30秒毎。間の SOC は 2920 の ∫Pbat 内挿で復元＝中央 ~0.6% 精度）。**12V系電圧は 2920 の byte14（×0.1V/LSB、PID42 と r=1.000）から取得**し、`0142` のポーリングは廃止。SOC/12V を 2920 に寄せ、2920 は ~2Hz（往復 ~450ms が BLE 律速の上限）で取得。
