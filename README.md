...
> SOC は PID `015B`（3秒毎）。**12V系電圧は 2920 の byte14（×0.1V/LSB、PID42 と r=1.000）から取得**し、`0142` のポーリングは廃止して枠を 2920 に回した。SOC を間引いて 2920 の枠を確保し、2920 は ~2Hz（往復 ~450ms が BLE 律速の上限）で取得。
