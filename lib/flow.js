...
function drawFlowLandscape(svg, S){
  ...
  if(regen) fArrow(svg,[[gTX-4,gWY],[gWX+24,gWY]],'mech',on(trcWheel),on(trcWheel)?trcWheel:null,274,30,FX_R,null,20);
  else      fArrow(svg,[[gWX+24,gWY],[gTX-4,gWY]],'mech',on(trcWheel),on(trcWheel)?trcWheel:null,274,30,FX_M,null,20);
